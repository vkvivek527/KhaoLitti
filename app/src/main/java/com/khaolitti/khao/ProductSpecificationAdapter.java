...
public class ProductSpecificationAdapter extends RecyclerView.Adapter<ProductSpecificationAdapter.ViewHolder> {
    ...
    public ProductSpecificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       ...
       switch (viewType) {
           ...
           case ProductSpecificationModel.SPECIFICATION_BODY:
               View view =LayoutInflater.from(parent.getContext()).inflate(R.layout.product_specificatiom_item_layout,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private TextView featuresNames;
        private TextView featureValues;
        ...
        private void setFeature(String featureTitle,String featureDetail){
            featuresNames= itemView.findViewById(R.id.feature_name);
            featureValues=itemView.findViewById(R.id.feature_values);

            featuresNames.setText(featureTitle);
            featureValues.setText(featureDetail);
        }
